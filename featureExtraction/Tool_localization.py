...
def cal_crosstab_sub_one(Nf, Ns, Ncfw, Ncsw, Nufw, Nusw):
    N = Nf + Ns
    Sw = 0
    Ncw = Ncfw + Ncsw
    Nuw = Nufw + Nusw
...
def cal_crosstab_sub_two(Nf, Ns, Ncfw, Ncsw, Nufw, Nusw):
    N = Nf + Ns
    Sw = 0
    Ncw = Ncfw + Ncsw
    Nuw = Nufw + Nusw
...
def cal_crosstab_sub_three(Nf, Ns, Ncfw, Ncsw, Nufw, Nusw):
    N = Nf + Ns
    Sw = 0
    Ncw = Ncfw + Ncsw
    Nuw = Nufw + Nusw
...
def cal_crosstab_sub_four(Nf, Ns, Ncfw, Ncsw, Nufw, Nusw):
    N = Nf + Ns
    Sw = 0
    Ncw = Ncfw + Ncsw
    Nuw = Nufw + Nusw
...
def cal_formula_suspicion(name, formula, aef, aep, anf, anp, tf, tp, index):
    ...
    try:
        if name == 'crosstab':
            ...
            res = cal_crosstab_sub_one(tf, tp, aef, aep, anf, anp)
        elif name == 'crosstab2':
            res = cal_crosstab_sub_two(tf, tp, aef, aep, anf, anp)
        elif name == 'crosstab3':
            res = cal_crosstab_sub_three(tf, tp, aef, aep, anf, anp)
        elif name == 'crosstab4':
            res = cal_crosstab_sub_four(tf, tp, aef, aep, anf, anp)
        else:
            res = eval(formula)
...
def normalization(SS_or,CR_or,SF_or, FM_or, versionPath):
    ...
    # res_nor = Tool_io.checkAndLoad(versionPath[1], "normalizationtest_sf")
    res_nor = Tool_io.checkAndLoad(versionPath[1], "normalizationFm_sf_test")
    if res_nor != None:
        return res_nor
    ...
    Tool_io.checkAndSave(versionPath[1], "normalizationFm_sf_test", res_nor)
    return res_nor
